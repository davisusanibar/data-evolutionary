...
public class DevolverSourceFunctionConDataFakeDeterm extends RichParallelSourceFunction<RowData> {
    ...
    public void run(SourceContext<RowData> ctx) throws Exception {
        ...
        while (isRunning) {
            ...
            if (deterministicIndex == 1) {
                dataFakeDeRowData.setField(0, StringData.fromString("gladis-01"));
                dataFakeDeRowData.setField(1, tiempoDelEvento);
            }

            if (deterministicIndex == 2) {
                dataFakeDeRowData.setField(0, StringData.fromString("gladis-02"));
                dataFakeDeRowData.setField(1, tiempoDelEvento);
            }

            if (deterministicIndex == 3) {
                dataFakeDeRowData.setField(0, StringData.fromString("gladis-03-acid"));
                dataFakeDeRowData.setField(1, tiempoDelEvento);
            }

            if (deterministicIndex == 4) {
                dataFakeDeRowData.setField(0, StringData.fromString("gladis-04"));
                dataFakeDeRowData.setField(1, tiempoDelEvento);
