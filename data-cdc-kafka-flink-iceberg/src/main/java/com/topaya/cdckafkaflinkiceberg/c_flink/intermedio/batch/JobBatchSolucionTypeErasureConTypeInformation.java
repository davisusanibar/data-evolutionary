...
public class JobBatchSolucionTypeErasureConTypeInformation {
    private static final Logger logger =
            LoggerFactory.getLogger(JobBatchSolucionTypeErasureConTypeInformation.class);
    ...
    public static void main(String[] args) {
        try (final StreamExecutionEnvironment env =
            ...
            env.execute("Demo-Ejemplo-Intermedio-Usando-TypeInformation");
