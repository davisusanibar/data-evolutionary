/* (C)2024 */
package com.topaya.cdckafkaflinkiceberg.d_iceberg.hadoop_hdfs.batch;
...
public class JobDataStreamToIcebergToHadoopCatalogo {
    ...
    public static void main(String[] args) {
        ...
        try (final StreamExecutionEnvironment env =
            ...
            configuracionIceberg.put("warehouse", "hdfs://namenode/catalogo/hadoop/batch");
            ...
            String baseDatos = "db";
            String tableName = "nombres_hadoop_batch";
            ...
            FlinkSink.builderFor(
                    ...
                    .append()
                    .setParallelism(3)
                    .name("sink-iceberg-catalogo-hdfs");

            env.execute("Demo-Ejemplo-Iceberg-Streaming-Hadoop");
