...
/**
 * Revenue por cliente en ventana temporal — KCD.
 *
...
public final class RevenueWindowJob {
  ...
  public static void main(String[] args) throws Exception {
    ...
    String inputTopic = params.get("input-topic", "orders-kcd001");
    ...
    KafkaSource<OrderEvent> source =
        KafkaSource.<OrderEvent>builder()
            ...
            .setGroupId("kcd001-revenue-ventana")
    ...
    env.execute("KCD · revenue por cliente en ventana temporal");
  }
}
